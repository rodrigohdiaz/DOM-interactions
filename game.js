...
function makeGreen (evt) {
  ...
  if(evt.target.classList.length >= 1 && evt.target.classList !== 'green'){
...
function makeBlue (evt) {
  ...
  if(evt.target.classList.length >= 1 && evt.target.classList !== 'blue'){
...
function hide (evt) {
  if(evt.target.classList.length >= 1 && evt.target.classList !== 'invisible'){
